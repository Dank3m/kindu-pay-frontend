        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
            ...
            <a href="http://localhost:1313/" className="flex ml-2 md:mr-24">
              <img
                src="http://localhost:1313/images/logo.svg"
                className="h-8 mr-3"
                alt="FlowBite Logo"
              />
              ...
              <div>
                ...
                >
                  <div className="flex-shrink-0">
                    <img
                      className="rounded-full w-11 h-11"
                      src="/src/assets/images/users/jese-leos.png"
                      alt="Jese image"
                    />
                ...
                >
                  <div className="flex-shrink-0">
                    <img
                      className="rounded-full w-11 h-11"
                      src="/src/assets/images/users/joseph-mcfall.png"
                      alt="Joseph image"
                    />
                ...
                >
                  <div className="flex-shrink-0">
                    <img
                      className="rounded-full w-11 h-11"
                      src="/src/assets/images/users/leslie-livingston.png"
                      alt="Leslie image"
                    />
                ...
                >
                  <div className="flex-shrink-0">
                    <img
                      className="rounded-full w-11 h-11"
                      src="/src/assets/images/users/robert-brown.png"
                      alt="Robert image"
                    />
